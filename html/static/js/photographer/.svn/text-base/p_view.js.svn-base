			   ...
			   ' <ul class="first_ul">'+  
	     	     '<li class="first_lis">'+
			       '<a class="select_target" data="1">'+
			        '<i class="weeding_dress"></i>'+
			        '<div class="smal_circle_div"><i class="smal_circle"></i></div>'+
			       '</a>'+
			      '<span>婚纱</span>'+
			      '</li>'+
				 '<li class="first_lis">'+
			        '<a class="select_target" data="2">'+
			          '<i class="person_almun"></i>'+
			          '<div class="smal_circle_div"><i class="smal_circle"></i></div>'+
			        '</a> '+
			        '<span>写真</span>'+
			     '</li>'+
...
var three_tm = '<div class="step_three_box">'+
 ...
 var four_tm = '<div class="step_four_box">'+
			    ...
			    '<div class="four_button infor_button">'+
			      ...
			      '<button class="next_step3 next_step" id="four_step">下一步</button><div id="five-load"><img width="30" height="30" src="/static/images/thumbnails/loading.gif"><span class="loading-span">上传中请稍候...</span></div>'+
			   ' </div>'+ 
			  '</div>';
